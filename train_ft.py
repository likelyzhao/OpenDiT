...
from opendit.dataset.mutilTFRecordImageDataset import MutilTFRecordImageDataset
...
def main(args):
    ...
    if args.pretrain is not None:
        ...
        is_index_file, index_file_path = has_index_file(args.pretrain)
    ...
    if args.num_samples == -1:
        ...
        dataset.length = args.num_samples // dist.get_world_size()
        use_sample = False
        dataloader = prepare_dataloader(
            dataset,
            batch_size=args.batch_size,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrain", type=str, default=None, help="Path to a pretraining model dir to load")
